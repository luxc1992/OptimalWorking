...
public class OnCarriageFragment extends BaseFragment implements GoodsManageInter, OnRefreshLoadmoreListener {
    ...
    public void init() {
        ...
        goodsAdapter = new GoodsManageAdapter(getActivity(), Constant.NO0, this);
    ...
    private void getGoodsList() {
        RequestApi.getGoodsList(App.manager.getPhoneNum(),App.manager.getUuid(),String.valueOf(Constant.NO1), String.valueOf(page), String.valueOf(Constant.NO10), new AbstractNetWorkCallback<GoodsBean>() {
            @Override
