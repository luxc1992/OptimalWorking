 ...
 * @date 2018/5/17
 */
public class CardUnionWaitPayOrderFragment extends LazyBaseFragment implements OnRefreshListener, OnLoadmoreListener {
...
//        requestData(page);
    ...
    private void requestData(final int page) {
        RequestApi.getCardUnionOrderList(App.manager.getPhoneNum(), App.manager.getUuid(), App.manager.getId()+"", String.valueOf(0), page, new AbstractNetWorkCallback<CardUnionOrderBean>() {
            @Override
            public void onAfter() {
                super.onAfter();
                loadFinish();
