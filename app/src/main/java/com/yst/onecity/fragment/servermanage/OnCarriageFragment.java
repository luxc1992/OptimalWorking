...
public class OnCarriageFragment extends BaseFragment implements OnRefreshLoadmoreListener, ServiceManageInter {
     ...
     * 创建实例
     *
     * @return OnCarriageFragment
     */
    public static OnCarriageFragment newInstance() {
        return new OnCarriageFragment();
    }
    ...
    private void getList() {
        RequestApi.getServiceList(String.valueOf(App.manager.getId()), String.valueOf(Constant.NO1), String.valueOf(page), String.valueOf(Constant.NO10), new AbstractNetWorkCallback<ServerManageBean>() {
            @Override
    ...
    public void init() {
        ...
        goodsAdapter = new ServerManageAdapter(getActivity(), Constant.NO0, this);
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_piliang_manage:
                ...
                bundle.putInt("type", Constant.NO1);
    ...
    private void showSureDialog(final String strId) {
        AbstractDeleteDialog dialog = new AbstractDeleteDialog(getActivity()) {
            ...
            public void sureClick() {
                ...
                RequestApi.serviceOperate(String.valueOf(Constant.NO1), strId, new AbstractNetWorkCallback<MsgBean>() {
                    @Override
