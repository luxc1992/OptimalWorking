 ...
 * @date 2018/2/6
 */
public class HunterOrderFragment extends BaseFragment implements HunterOrderAdapter.OrderClickListener, OnRefreshListener, OnLoadmoreListener {
    ...
    private int type = 0;
    /**
     * （原：订单状态 0待付款 2待发货（已付款） 3待收货 4已评价 6已撤销 7已收货（待评价）8 全部）
     * 订单状态 0待付款 1待使用 2待评价 3待发货 4已发货  8 全部
     */
