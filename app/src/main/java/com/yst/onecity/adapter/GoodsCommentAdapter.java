...
public class GoodsCommentAdapter extends BaseAdapter implements SendCommentDialog.SendCommentListener {
    private Context context;
    private List<GoodsCommentBean.ContentBean.BigListBean> commmentList = new ArrayList<>();
    ...
    public GoodsCommentAdapter(Context context, String advisor) {
        this.context = context;
        this.advisor = advisor;
    }

    public void addData(List<GoodsCommentBean.ContentBean.BigListBean> mList) {
        if (null != mList) {
            commmentList.clear();
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tvCommentTime.setText(Utils.getCustomStrTime(String.valueOf(commmentList.get(i).getCommentTime()),"yyyy-MM-dd HH:mm:ss"));
        viewHolder.tvContent.setText(commmentList.get(i).getContent());
        viewHolder.tvName.setText(commmentList.get(i).getProductName());
        viewHolder.tvGuige.setText(commmentList.get(i).getProductSpecificationName() + String.valueOf(commmentList.get(i).getProductSalePrice()));
        viewHolder.tvCreateTime.setText(commmentList.get(i).getCreatedTime());
        ...
        returnContent = (String) commmentList.get(i).getReturnContent();
    ...
    private void replay(final String content) {
        RequestApi.replayComment(String.valueOf(App.manager.getId()), commentid,
                ...
                , commentid, "", App.manager.getPhoneNum(), App.manager.getUuid(), new AbstractNetWorkCallback<MsgBean>() {
                    @Override
