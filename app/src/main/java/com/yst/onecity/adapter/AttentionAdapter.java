...
public class AttentionAdapter extends BaseAdapter {
    ...
    public AttentionAdapter(Context mContext, List<FansOrAttentionsListBean.ContentBean.ListBean> fansList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvState.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onListener(fansList.get(position).getId() + "", position);
                }
            }
        });
    ...
    public interface OnListener {
         ...
         * @param position 索引
         */
        void onListener(String id, int position);
        /**
         * 点击头像跳转个人信息页面
         * @param position 下标
         */
