...
import com.yst.onecity.view.viewpagerindicator.interfaces.ScrollState;
import com.yst.onecity.view.viewpagerindicator.titleview.IMeasurablePagerTitleView;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private AbstractCommonNavigatorAdapter mAdapter;
    ...
    private float mScrollPivotX = 0.7f;
    ...
    public AbstractCommonNavigatorAdapter getAdapter() {
        return mAdapter;
    }

    public void setAdapter(AbstractCommonNavigatorAdapter adapter) {
        if (mAdapter == adapter) {
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout.layout_viewpager_indicator_no_scroll, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout.layout_viewpager_indicator_scroll, this);
        }
