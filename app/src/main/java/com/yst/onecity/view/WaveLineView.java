...
public class WaveLineView extends View {
     ...
     * 波形的颜色
     */
    private int waveColor = 0xaa417CF2;
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        z = typedArray.getDimensionPixelOffset(R.styleable.RadarWaveView_waveAmplitude, dp2px(10));
    ...
    private void fillTop(Canvas canvas) {
        ...
        for (float x = 0; x <= getWidth(); x += NO20) {
            y = (float) (z * Math.sin(j * x + c + Math.PI * startPeriod) + p);
