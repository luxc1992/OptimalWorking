...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    private int mTextSelectedColor = Color.parseColor("#ED5452");
    private int mTextEmptyColor = Color.parseColor("#333333");
    /**
     * 顶部的tab集合
     */
     ...
     * 列表文字选中的颜色
     */
    private int listTextSelectedColor = Color.parseColor("#ED5452");
    /**
     * 列表icon资源
     */
    ...
    private void init(Context context){
        ...
        tabLayout.setWeightSum(tabAmount);
        tabLayout.setLayoutParams(new LayoutParams(
        ...
        grayLine.setBackgroundColor(ContextCompat.getColor(mContext, R.color.color_DDDDDD));
        addView(grayLine);
    ...
    private Tab newTab(CharSequence text,boolean isSelected){
        ...
        tab.setPadding(5,15,5,15);
        tab.setSelected(isSelected);
        tab.setText(text);
        tab.setTextEmptyColor(mTextEmptyColor);
        tab.setTextSelectedColor(mTextSelectedColor);
    ...
    public void setTextEmptyColor(int textEmptyColor) {
        mTextEmptyColor = textEmptyColor;
    }
    /**
     * 设置Tab横线的颜色
     * */
    ...
    public class Tab extends TextView{
        private int index = 0;
        private int sTextSelectedColor = Color.parseColor("#ED5452");
        private int sTextEmptyColor = Color.parseColor("#333333");
        /**
         * 是否选中状态
         * */
        ...
        public void setText(CharSequence text, BufferType type) {
            if(isSelected) {
                setTextColor(sTextSelectedColor);
            } else {
                setTextColor(sTextEmptyColor);
            }
        ...
        public void setTextSelectedColor(int textSelectedColor) {
            sTextSelectedColor = textSelectedColor;
        }

        public void setTextEmptyColor(int textEmptyColor) {
            sTextEmptyColor = textEmptyColor;
        }
    }
    /**
     * 横线控件
    ...
    private class Line extends LinearLayout{
        ...
        private int mSelectedColor = Color.parseColor("#ED5452");
        ...
        private void init(Context context){
            ...
            indicator.setBackgroundColor(mSelectedColor);
            addView(indicator);
        }
        public void setIndex(int index){
