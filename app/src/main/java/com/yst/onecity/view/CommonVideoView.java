...
public class CommonVideoView extends FrameLayout implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, View.OnTouchListener, View.OnClickListener, Animator.AnimatorListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void initView() {
        ...
        videoPauseBtn = view.findViewById(R.id.videoPauseBtn);
        screenSwitchBtn = view.findViewById(R.id.screen_status_btn);
        videoControllerLayout = view.findViewById(R.id.videoControllerLayout);
        touchStatusView = view.findViewById(R.id.touch_view);
        touchStatusImg = view.findViewById(R.id.touchStatusImg);
        touchStatusTime = view.findViewById(R.id.touch_time);
        videoCurTimeText = view.findViewById(R.id.videoCurTime);
        videoTotalTimeText = view.findViewById(R.id.videoTotalTime);
        videoSeekBar = view.findViewById(R.id.videoSeekBar);
        videoPlayImg = view.findViewById(R.id.videoPlayImg);
        videoPlayImg.setVisibility(GONE);
        videoPauseImg = view.findViewById(R.id.videoPauseImg);
