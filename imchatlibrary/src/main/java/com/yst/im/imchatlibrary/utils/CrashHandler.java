...
public class CrashHandler {
    ...
    static {
        try {
            PackageInfo pi = MyApp.getInstance().getPackageManager().getPackageInfo(MyApp.getInstance().getPackageName(), 0);
            if (pi != null) {
        ...
        UNCAUGHT_EXCEPTION_HANDLER = new UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread t, final Throwable e) {
                ...
                Format mFormat = new SimpleDateFormat("MM-dd HH-mm-ss", Locale.getDefault());
                String fileName = mFormat.format(now) + ".txt";
    ...
    public static boolean init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            defaultDir = MyApp.getInstance().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        } else {
            defaultDir = MyApp.getInstance().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
