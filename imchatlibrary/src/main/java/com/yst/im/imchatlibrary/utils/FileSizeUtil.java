...
public class FileSizeUtil {
    ...
    private static String formatFileSize(long fileS) {
        ...
        } else if (fileS < NUM_1024 * NUM_1024) {
            fileSizeString = df.format((double) fileS / NUM_1024) + " KB";
        } else if (fileS < NUM_1024 * NUM_1024 * NUM_1024) {
            fileSizeString = df.format((double) fileS / NUM_1024 * NUM_1024) + " MB";
        } else {
            fileSizeString = df.format((double) fileS / NUM_1024 * NUM_1024 * NUM_1024) + " GB";
        }
