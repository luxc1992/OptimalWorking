...
import com.yst.im.imchatlibrary.adapter.MultiFolderAdapter;
import com.yst.im.imchatlibrary.adapter.MultiImageGridAdapter;
import com.yst.im.imchatlibrary.base.Folder;
import com.yst.im.imchatlibrary.base.Image;
import com.yst.im.imchatlibrary.utils.MultiFileUtils;
import com.yst.im.imchatlibrary.utils.MultiScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    private MultiImageGridAdapter mImageAdapter;
    private MultiFolderAdapter mFolderAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.mis_fragment_multi_image_im, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mImageAdapter = new MultiImageGridAdapter(getActivity(), showCamera(), 3);
        ...
        mFolderAdapter = new MultiFolderAdapter(getActivity());
    }
    ...
    private void createPopupFolderList() {
        Point point = MultiScreenUtils.getScreenSize(getActivity());
        int width = point.x;
    ...
    private void showCameraAction() {
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                try {
                    mTmpFile = MultiFileUtils.createTmpFile(getActivity());
                } catch (IOException e) {
                    e.printStackTrace();
                }
