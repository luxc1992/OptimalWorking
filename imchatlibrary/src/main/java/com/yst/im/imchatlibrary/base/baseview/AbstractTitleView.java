package com.yst.im.imchatlibrary.base.baseview;
 ...
 * @date 2018/03/06.
 */
public class AbstractTitleView extends RelativeLayout {
    /**
     * 文字颜色
     */
    ...
    public AbstractTitleView(Context context) {
        this(context, null);
    }
    ...
    public AbstractTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initLeftTextView(Context context, TypedArray typeArray) {
        ...
        mLeftBackTextTv.setTextColor(getLeftTextColorFromAttr(typeArray));
    ...
    private void initRightTextView(Context context, TypedArray typeArray) {
        ...
        mRightTextTv.setTextColor(getRightTextColorFromAttrs(typeArray));
     ...
     * @return textColor
     */
    private int getLeftTextColorFromAttr(TypedArray typeArray) {
        int textColorStyleable = typeArray.getResourceId(R.styleable.TitleAttr_left_text_color, 0);
        if (textColorStyleable > 0) {
            return typeArray.getResources().getColor(textColorStyleable);
        } else {
            return typeArray.getColor(R.styleable.TitleAttr_left_text_color, textColor);
        }
    }
     ...
     * @return textColor
     */
    private int getRightTextColorFromAttrs(TypedArray typeArray) {
        int textColorStyleable = typeArray.getResourceId(R.styleable.TitleAttr_right_text_color, 0);
        if (textColorStyleable > 0) {
            return typeArray.getResources().getColor(textColorStyleable);
        } else {
            return typeArray.getColor(R.styleable.TitleAttr_right_text_color, textColor);
        }
    }
    ...
    public void setRightTextTvIsVisible(boolean flag) {
        if (flag) {
    ...
    public void setRightTvText(String rightTvText) {
        ...
        mRightTextTv.setText(rightTvText);
    }
    ...
    public void setLeftTvText(String str) {
        if (mLeftBackTextTv == null) {
            return;
        }
        mLeftBackTextTv.setText(str);
    }
    public void setRightDrawable(Drawable drawable) {
        if (mRightImageIv == null) {
            return;
        }
        mRightImageIv.setImageDrawable(drawable);
    }
}
