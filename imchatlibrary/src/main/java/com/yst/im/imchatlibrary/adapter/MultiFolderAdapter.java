 ...
 * @date 2018/03/30.
 */
public class MultiFolderAdapter extends BaseAdapter {
    ...
    public MultiFolderAdapter(Context context) {
        mContext = context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if (view == null) {
            view = mInflater.inflate(R.layout.mis_list_item_folder_im, viewGroup, false);
