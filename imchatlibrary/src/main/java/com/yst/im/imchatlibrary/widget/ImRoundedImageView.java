...
import com.yst.im.imchatlibrary.base.baseview.ImRoundedDrawable;
...
public class ImRoundedImageView extends ImageView {
    ...
    private ColorStateList borderColor =
            ColorStateList.valueOf(ImRoundedDrawable.DEFAULT_BORDER_COLOR);
    ...
    public ImRoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(ImRoundedDrawable.DEFAULT_BORDER_COLOR);
        }
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = ImRoundedDrawable.fromDrawable(drawable);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = ImRoundedDrawable.fromBitmap(bm);
        updateDrawableAttrs();
        super.setImageDrawable(mDrawable);
    }
    ...
    private Drawable resolveResource() {
        ...
        return ImRoundedDrawable.fromDrawable(d);
    }
    ...
    private void updateBackgroundDrawableAttrs(boolean convert) {
        if (mutateBackground) {
            if (convert) {
                mBackgroundDrawable = ImRoundedDrawable.fromDrawable(mBackgroundDrawable);
            }
    ...
    public void setBorderColor(ColorStateList colors) {
        ...
        borderColor =
                (colors != null) ? colors : ColorStateList.valueOf(ImRoundedDrawable.DEFAULT_BORDER_COLOR);
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
        if (borderWidth > 0) {
            invalidate();
