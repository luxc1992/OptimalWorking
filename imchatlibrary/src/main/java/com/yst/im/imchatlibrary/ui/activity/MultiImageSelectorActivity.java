...
public class MultiImageSelectorActivity extends AppCompatActivity
    ...
    private TextView txtMisCloseSelect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mis_activity_default_im);
        ...
        txtMisCloseSelect = (TextView) findViewById(R.id.txt_mis_close_select);
        if(mode == MODE_MULTI){
        ...
        txtMisCloseSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
