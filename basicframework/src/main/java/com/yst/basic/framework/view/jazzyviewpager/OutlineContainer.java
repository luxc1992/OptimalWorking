...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(WindowUtils.dpToPx(getResources(), 2));
		mOutlinePaint.setColor(ContextCompat.getColor(getContext(), R.color.holo_blue));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = WindowUtils.dpToPx(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = WindowUtils.dpToPx(getResources(), 5);
