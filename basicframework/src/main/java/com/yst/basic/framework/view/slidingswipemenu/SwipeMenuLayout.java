...
public class SwipeMenuLayout extends FrameLayout {
	...
	private int mMinFling = dp2px(15);
	private int mMaxVelocityx = -dp2px(500);
	...
	private void init(int mid) {
		...
		mGestureListener = new SimpleOnGestureListener() {
			...
			public boolean onFling(MotionEvent e1, MotionEvent e2,
				...
				// TODO
				if ((e1.getX() - e2.getX()) > mMinFling
						&& velocityX < mMaxVelocityx) {
					isFling = true;
				}
	...
	public boolean onSwipe(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			if (isFling || (mDownX - event.getX()) > (mMenuView.getWidth() / Const.SWIPE_MENU_ACTION_UP_RATIO)) {
				// open
				smoothOpenMenu();
			} else {
				// close
