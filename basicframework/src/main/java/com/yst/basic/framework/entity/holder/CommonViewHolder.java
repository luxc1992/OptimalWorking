...
public class CommonViewHolder {
    ...
    public CommonViewHolder setVisiable(int viewId, int flag) {
        TextView tv = getView(viewId);
        tv.setVisibility(flag);
        return this;
    }

    public CommonViewHolder setLinearLayoutVisiable(int viewId, int flag) {
        LinearLayout ll = getView(viewId);
        ll.setVisibility(flag);
        return this;
    }

    public CommonViewHolder setRlVisiable(int viewId, int flag) {
        RelativeLayout rl = getView(viewId);
        rl.setVisibility(flag);
        return this;
    }

    public CommonViewHolder setImgVisiable(int viewId, int flag) {
        ImageView iv = getView(viewId);
        iv.setVisibility(flag);
        return this;
    }
     ...
     * @return
     */
    public CommonViewHolder setImageByUrl(Context context, int viewId, String url, int resId) {
        ImageView image = getView(viewId);
     ...
     * @param listener
     */
    public CommonViewHolder setButtonListener(int viewId, View.OnClickListener listener) {
     ...
     * @return
     */
    public CommonViewHolder setButtonLongListener(int viewId, View.OnLongClickListener listener) {
     ...
     * @param listener
     */
    public CommonViewHolder setTextListener(int viewId, View.OnClickListener listener) {
        getView(viewId).setOnClickListener(listener);
        return this;
    }
     ...
     * @param listener
     */
    public CommonViewHolder setLinearLayoutListener(int viewId, View.OnClickListener listener) {
        getView(viewId).setOnClickListener(listener);
        return this;
    }
     ...
     * @return
     */
    public CommonViewHolder setImageListener(int viewId, View.OnClickListener listener) {
        getView(viewId).setOnClickListener(listener);
        return this;
    }
